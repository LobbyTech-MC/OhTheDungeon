...
import otd.lib.net.querz.nbt.tag.DoubleTag;
import otd.lib.net.querz.nbt.tag.EndTag;
import otd.lib.net.querz.nbt.tag.FloatTag;
import otd.lib.net.querz.nbt.tag.IntArrayTag;
import otd.lib.net.querz.nbt.tag.IntTag;
import otd.lib.net.querz.nbt.tag.ListTag;
import otd.lib.net.querz.nbt.tag.LongArrayTag;
import otd.lib.net.querz.nbt.tag.LongTag;
