...
public class Vanilla extends BaseGenerator {
	...
	public void initC(long seed) {
		...
		noiseGen1 = new NoiseGeneratorOctaves3D(rand, 16, true);
		noiseGen2 = new NoiseGeneratorOctaves3D(rand, 16, true);
		noiseGen3 = new NoiseGeneratorOctaves3D(rand, 8, true);
		noiseGen4 = new NoiseGeneratorOctaves3D(rand, 4, true);
		noiseGen5 = new NoiseGeneratorOctaves3D(rand, 4, true);
		noiseGen6 = new NoiseGeneratorOctaves3D(rand, 10, true);
		noiseGen7 = new NoiseGeneratorOctaves3D(rand, 16, true);
...
//        generateCaves(world, chunkX, chunkZ, terrain);
	...
	public void replaceBlocksForBiome(int xPos, int zPos, AsyncChunk terrain) {
		...
		stoneNoise = noiseGen5.generateNoiseArray(stoneNoise, xPos * 16, zPos * 16, 0.0D, 16, 16, 1, d * 2D, d * 2D,
				d * 2D);
		for (int x = 0; x < 16; x++) {
			for (int z = 0; z < 16; z++) {
	...
	private double[] initNoiseField(double array[], int xPos, int yPos, int zPos, int xSize, int ySize, int zSize) {
		...
		noise3 = noiseGen3.generateNoiseArray(noise3, xPos, yPos, zPos, xSize, ySize, zSize, d0 / 80D, d1 / 160D,
				d0 / 80D);
		noise1 = noiseGen1.generateNoiseArray(noise1, xPos, yPos, zPos, xSize, ySize, zSize, d0, d1, d0);
		noise2 = noiseGen2.generateNoiseArray(noise2, xPos, yPos, zPos, xSize, ySize, zSize, d0, d1, d0);
		int k1 = 0;
		int l1 = 0;
		int i2 = 16 / xSize;
