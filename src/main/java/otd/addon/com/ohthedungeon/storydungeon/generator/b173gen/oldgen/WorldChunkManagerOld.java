...
public class WorldChunkManagerOld {
	...
	public BetaBiome[] getBiomeBlock(BetaBiome biomes[], int x, int z, int xSize, int zSize) {
		...
		temperatures = noise1.generateNoiseArray(temperatures, x, z, xSize, xSize, 0.02500000037252903D,
				0.02500000037252903D, 0.25D);
		rain = noise2.generateNoiseArray(rain, x, z, xSize, xSize, 0.05000000074505806D, 0.05000000074505806D,
