 ...
 * @author simplex
 */
public class Nordic extends BaseGenerator {
	 ...
	 */
	private static void setMaterialAt(final AsyncChunk chunk_data, final int x, final int y, final int z,
...
//                genWater(biomes, x, z, result);
	 ...
	 */
	private void applyHeightMap(final int x, final int z, final AsyncChunk chunk_data, final int currheight) {
	 ...
	 */
	private void genFloor(final int x, final int z, final AsyncChunk chunk_data) {
		for (int y = 0; y < 5; y++) {
	 ...
	 */
	private int genHighlands(final int x, final int z, final int xChunk, final int zChunk, final int current_height,
			final SimplexOctaveGenerator gen) {
	 ...
	 * @return generated height
	 */
	private int genHills(final int x, final int z, final int xChunk, final int zChunk, final int current_height,
			final SimplexOctaveGenerator gen) {
	 ...
	 */
	private int genGround(final int x, final int z, final int xChunk, final int zChunk,
			final SimplexOctaveGenerator gen) {
	 ...
	 */
	private int genMountains(final int x, final int z, final int xChunk, final int zChunk, final int current_height,
			final Voronoi noisegen) {
	 ...
	 */
	private int genBase(final int x, final int z, final int xChunk, final int zChunk, final SimplexOctaveGenerator gen,
			final Voronoi noisegen) {
	 ...
	 */
	private void genTopLayer(final int x, final int z, final AsyncChunk chunk_data, final int height) {
		boolean grass = true;
//        if (height < 48) {
//            grass = false;
//        }
	...
	public final void changeSeed(final long seed) {
