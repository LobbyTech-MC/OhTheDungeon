		...
		for (int x = 0; x < 3; ++x) {
			for (int z = 0; z < 3; ++z) {
				if (x != 1 || z != 1) {
					...
					if (generator.noise.isUrbanBuilding(x2, z2)
							&& generator.getWallMaterial(x2, z2) == this.wallMaterial
							&& generator.getFloorMaterial(x2, z2) == this.floorMaterial
							&& generator.getRoofMaterial(x2, z2) == this.roofMaterial) {
