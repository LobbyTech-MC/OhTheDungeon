...
public class BetaBiome {
	...
	public static final BetaBiome RAINFOREST = new BetaBiome("Rainforest", "RAINFOREST", "JUNGLE"),
			...
			FOREST = new BetaBiome("Forest", "FOREST"), SAVANNA = new BetaBiome("Savanna", "SAVANNA", "PLAINS"),
			SHRUBLAND = new BetaBiome("Shrubland", "SHRUBLAND", "PLAINS"), TAIGA = new BetaBiome("Taiga", "TAIGA"),
			DESERT = new BetaBiome("Desert", "DESERT"), PLAINS = new BetaBiome("Plains", "PLAINS"),
