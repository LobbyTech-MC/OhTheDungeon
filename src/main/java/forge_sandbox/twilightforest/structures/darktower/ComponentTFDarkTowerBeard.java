...
public class ComponentTFDarkTowerBeard extends StructureTFComponentOld {
	...
	public ComponentTFDarkTowerBeard(TFFeature feature, int i, ComponentTFTowerWing wing) {
		...
		this.boundingBox = new StructureBoundingBox(wing.getBoundingBox().minX,
				wing.getBoundingBox().minY - this.height, wing.getBoundingBox().minZ, wing.getBoundingBox().maxX,
	...
	protected void makeDarkBeard(AsyncWorldEditor world, StructureBoundingBox sbb, int minX, int minY, int minZ,
