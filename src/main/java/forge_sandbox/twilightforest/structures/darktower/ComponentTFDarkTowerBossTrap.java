...
public class ComponentTFDarkTowerBossTrap extends ComponentTFDarkTowerWing {
	...
	protected ComponentTFDarkTowerBossTrap(TFFeature feature, int i, int x, int y, int z, int pSize, int pHeight,
			BlockFace direction) {
...
//        this.setBlockState(world, Blocks.WOODEN_PRESSURE_PLATE.getDefaultState(), 2, 1, 8, sbb);
	 ...
	 */
	protected void addBossTrapFloors(AsyncWorldEditor world, Random rand, StructureBoundingBox sbb, int bottom,
			int top) {
