...
public class Tower_Room implements Treasure {
	...
	private final static LootTable[] TABLES = { Bukkit.getLootTable(LootTables.SIMPLE_DUNGEON.getKey()),
			Bukkit.getLootTable(LootTables.VILLAGE_SNOWY_HOUSE.getKey()),
			Bukkit.getLootTable(LootTables.VILLAGE_TAIGA_HOUSE.getKey()),
