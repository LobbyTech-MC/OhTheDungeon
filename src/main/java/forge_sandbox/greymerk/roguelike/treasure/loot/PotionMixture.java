...
public enum PotionMixture {
	...
	TEQUILA, MOONSHINE, ABSINTHE, VILE, LAUDANUM, RAGE, STOUT, STAMINA, NECTAR, COFFEE, AURA;
	...
	public static ItemStack getPotion(Random rand, PotionMixture type) {
		...
		case ABSINTHE:
			...
			return potion;
		case VILE:
			potion = Potion.getSpecific(rand, PotionForm.values()[rand.nextInt(PotionForm.values().length)],
