 ...
 * drawn. Each shape is cut from a unit square centered on 0,0 in the xz plane
 * and built from rectangles. This allows for shapes to be easily stretched to
 * fit areas they are added. In addition, they can be flipped on either axis and
 * come in pre-rotated variations, for easy transformation.
 * 
...
public final class Shape {
	 ...
	 * @param invertZ
	 */
	public void drawLiquid(Dungeon dungeon, Room room, float sx, float sz, float sdimx, float sdimz, boolean invertX,
			boolean invertZ) {
	...
	/**
	 * Add a walkway (normal floor at normal height) through a pool of previously
	 * added liquid. This is mostly for use with whole room shapes.
	 * 
	 * @param dungeon
	 * @param room
	 * @param sx      the x coordinate
	 ...
	 * @param invertZ
	 */
	public void drawWalkway(Dungeon dungeon, Room room, float sx, float sz, byte sdimx, byte sdimz, boolean invertX,
			boolean invertZ) {
		for (Rectangle rect : rectangles) {
	 ...
	 * @param invertZ
	 */
	public void drawCutout(Dungeon dungeon, Room room, float sx, float sz, float sdimx, float sdimz, boolean invertX,
			boolean invertZ) {
		for (Rectangle rect : rectangles) {
	...
	/**
	 * Removes walls from an area of this shape (cuts into the wall); this is mostly
	 * for use with whole room shapes.
	 * 
	 * @param dungeon
	 * @param room
	 * @param sx      the x coordinate
	 ...
	 * @param invertZ
	 */
	public void drawCutin(Dungeon dungeon, Room room, float sx, float sz, byte sdimx, byte sdimz, boolean invertX,
			boolean invertZ) {
		for (Rectangle rect : rectangles) {
	...
	// 'S' (Works)
	public static final Shape S000 = new Shape(
			new Rectangle[] { stop000, smiddle000, sbottom000, sleft000, sright000 });
	public static final Shape S090 = new Shape(
			new Rectangle[] { stop090, smiddle090, sbottom090, sleft090, sright090 });
	...
	public static final Shape[][] allshapes = { xgroup, lgroup, ogroup, tgroup, fgroup, egroup, igroup, cgroup, ugroup,
			sgroup };
