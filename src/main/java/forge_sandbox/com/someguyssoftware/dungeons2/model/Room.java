...
public class Room {
	...
	// TODO these next sets only belong to surface/exterior rooms and probably
...
//            setQuad(room.getQuad());
	...
	public void centerOn(ICoords coords) {
		setCoords(new Coords(coords.getX() - (getWidth() / 2), coords.getY(), coords.getZ() - (getDepth() / 2)));
	}
	 ...
	 */
	public static BlockFace getHorizontal(int direction) {
		return HORIZONTALS[abs(direction % HORIZONTALS.length)];
	}
	 ...
	 */
	public static Comparator<Room> idComparator = (Room p1, Room p2) -> {
	 ...
	 */
	public static Comparator<Room> distanceComparator = (Room p1, Room p2) -> {
	 ...
	 */
	public final Room setCoords(ICoords coords) {
		this.coords = coords;
		return this;
	}
...
//    }
	 ...
	 */
	public final Room setDepth(int depth) {
		this.depth = depth;
		return this;
	}
	 ...
	 */
	public final Room setWidth(int width) {
		this.width = width;
		return this;
	}
	 ...
	 */
	public final Room setHeight(int height) {
		this.height = height;
		return this;
	}
	 ...
	 */
	public final Room setAnchor(boolean anchor) {
		this.anchor = anchor;
		return this;
	}
	...
	public enum Type {
		GENERAL("general"), LADDER("ladder"), ENTRANCE("entrance"), EXIT("exit"), TREASURE("treasure"), BOSS("boss"),
		HALLWAY("hallway");
	 ...
	 */
	public final Room setStart(boolean start) {
		this.start = start;
		return this;
	}
	 ...
	 */
	public final Room setEnd(boolean end) {
		this.end = end;
		return this;
	}
	 ...
	 */
	public final Room setDegrees(int degrees) {
	 ...
	 * @param doors
	 */
	public final void setDoors(List<Door> doors) {
		this.doors = doors;
	}
