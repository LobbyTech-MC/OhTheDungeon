...
public class RoomGeneratorFactory {
	...
	public RoomGeneratorFactory(Multimap<String, IRoomGenerator> registry) {
		 ...
		 */
		// add all rooms
		registry.put("standard-room",
				new RoomGenerator(new StandardRoomGenerationStrategy(new StandardBlockProvider())));
		registry.put("standard-room",
				new RoomGenerator(new StandardRoomGenerationStrategy(new PillarRingRoomBlockProvider())));
		registry.put("standard-room",
				new RoomGenerator(new StandardRoomGenerationStrategy(new SinglePillarRoomBlockProvider())));
		registry.put("standard-room",
				new RoomGenerator(new StandardRoomGenerationStrategy(new CheckedFloorRoomBlockProvider())));
		// add all entrance rooms
		registry.put("standard-entrance",
				new EntranceRoomGenerator(new StandardRoomGenerationStrategy(new EntranceRoomBlockProvider())));
		// add all start rooms
		 ...
		 */
		registry.put("supported-room",
				new RoomGenerator(new SupportedRoomGenerationStrategy(new StandardBlockProvider())));
		registry.put("supported-room",
				new RoomGenerator(new SupportedRoomGenerationStrategy(new PillarRingRoomBlockProvider())));
		registry.put("supported-room",
				new RoomGenerator(new SupportedRoomGenerationStrategy(new SinglePillarRoomBlockProvider())));
		registry.put("supported-room",
				new RoomGenerator(new SupportedRoomGenerationStrategy(new CheckedFloorRoomBlockProvider())));
		// add all entrance rooms
		registry.put("supported-entrance",
				new EntranceRoomGenerator(new SupportedRoomGenerationStrategy(new EntranceRoomBlockProvider())));
	 ...
	 * @return
	 */
	public IRoomGenerator createHallwayGenerator(Hallway hallway, List<Room> rooms, List<Hallway> hallways,
			Boolean useSupport) {
		if (useSupport) {
...
//            gen = new RoomGenerator(new SupportedRoomGenerationStrategy(new StandardBlockProvider()));
	...
	public IRoomGenerator createStandardHallwayGenerator(Hallway hallway, List<Room> rooms, List<Hallway> hallways) {
		HallwayGenerator gen = new HallwayGenerator(
				new StandardHallwayGenerationStrategy(new HallwayBlockProvider(), rooms, hallways));
		return gen;
	}
	...
	public IRoomGenerator createSupportedHallwayGenerator(Hallway hallway, List<Room> rooms, List<Hallway> hallways) {
		HallwayGenerator gen = new HallwayGenerator(
				new SupportedHallwayGenerationStrategy(new HallwayBlockProvider(), rooms, hallways));
		return gen;
	}
	...
	public IRoomGenerator createStandardShaftGenerator(Room shaft) {
		IRoomGenerator gen = new RoomGenerator(new StandardRoomGenerationStrategy(new ShaftBlockProvider()));
		return gen;
	}
